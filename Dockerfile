...
# Symlink next-env.d.ts to /tmp so Next.js dev server can write it despite readOnlyRootFilesystem
RUN ln -sf /tmp/next-env.d.ts /app/html-anything/next/next-env.d.ts
EXPOSE 3000
ENV PORT=3000
